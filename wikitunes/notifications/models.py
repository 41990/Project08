...
class Notification(models.Model):
    ...
    recipient = models.ForeignKey('accounts.CustomUser', on_delete=models.CASCADE, help_text="User receiving the notification.")
...
class NotificationLog(models.Model):
    ...
    user = models.ForeignKey('accounts.CustomUser', on_delete=models.CASCADE, help_text="User who interacted with the notification.")
